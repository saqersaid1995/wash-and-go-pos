...
import {
  ChevronRight, FileText, Printer, Package, AlertTriangle,
  CheckCircle2, Truck,
} from "lucide-react";
...
export default function ScanResultCard({ order, onMoveNext, onMarkDelivered, onPrint }: ScanResultCardProps) {
  ...
  return (
    <div className="pos-section space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {isReady && (
          <Button size="sm" className="h-9 text-xs gap-1.5 flex-1 min-w-[120px] bg-success hover:bg-success/90 text-success-foreground" onClick={onMarkDelivered}>
